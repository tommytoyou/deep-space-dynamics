      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-sm text-gray-600 mt-2">
              Senior IS executive and former DISA Cyber Analyst with 15+ years experience in asset integrity and information security.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-sm text-gray-600 mt-2">
              Former CEO & founder, Deep Planet. Expert in space intelligence for global critical infrastructure.
            </p>
          </div>
        </div>
      </div>
